...
(Previously: parity was defined against an older single-page homepage reference.)
...
(Previously: composition required only section order and responsive identity preservation.)
...
(Previously: internal-only enforcement covered homepage links but allowed unspecified placeholders.)
