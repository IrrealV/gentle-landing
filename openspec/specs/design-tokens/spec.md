...
Define the Functional Brutalism token contract used across `/`, `/features`, `/docs`, `/how-it-works`, and `/configurator`, including palette, typography, shape, icon font, and utility primitives required for consistent rendering.
